                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <button
                        ...
                        className="text-sm font-medium text-blue-700 hover:text-blue-900 hover:underline text-left truncate block"
                      >
                        {userData.name}
                      </button>
                    ...
                    <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4 min-w-0">
                          <button
                            onClick={() => navigate(`/user/${userData._id}`)}
                            className="text-sm font-medium text-blue-700 hover:text-blue-900 hover:underline truncate max-w-[150px] md:max-w-none block text-left"
                          >
                            {userData.name}
                          </button>
                    ...
                    <td className="px-4 md:px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4 min-w-0">
                          <button
                            onClick={() => navigate(`/user/${userData._id}`)}
                            className="text-sm font-medium text-blue-700 hover:text-blue-900 hover:underline truncate max-w-[100px] md:max-w-[150px] block text-left"
                          >
                            {userData.name}
                          </button>
